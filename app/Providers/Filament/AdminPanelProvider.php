...
class AdminPanelProvider extends PanelProvider
{
    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            // Domain klasörüne yönlendirme
            ->discoverResources(in: app_path('Domain'), for: 'App\\Domain')
            // Orijinal Filament Resources klasörünü de dahil et
            ->discoverResources(in: app_path('Filament/Resources'), for: 'App\\Filament\\Resources')

            // Domain klasörüne yönlendirme
            ->discoverPages(in: app_path('Domain'), for: 'App\\Domain')
            // Orijinal Filament Pages klasörünü de dahil et
        ...
        $plugins = [
            ...
            BreezyCore::make()
                ->myProfile(
                    ...
                    navigationGroup: 'Kullanıcı Yönetimi', // Türkçeye çevirdim
